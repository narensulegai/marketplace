        ...
        <div className="row">
          <div className="col-12 mt-3">
            ...
            <>
              ...
              <div><span className="inputLabel">Sold by</span>{job.company.name}</div>
              <div><span className="inputLabel">Seller will ship product</span><span>{job.inPerson ? 'Yes' : 'No'}</span></div>
